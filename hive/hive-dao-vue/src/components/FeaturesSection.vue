  ...
  <div>
    ...
    <div id="features-features-23">
      <section class>
        <div class="container">
          <h3
            class="d-inline-block mt-0 mb-5 border-bottom border-warning border-md"
          >
            {{ $t("features.process") }}
          </h3>
          <div class="row">
              ...
              >
                <div class="card-body">
                  <h5 class="h4 text-white">
                    {{ $t("features.processStep1Title") }}
                  </h5>
                  <p class="mt-4 mb-0 text-white">
                    {{ $t("features.processStem1Info") }}
                  </p>
                </div>
              </div>
            </div>
            <div class="col-lg-3">
              ...
              >
                <div class="card-body">
                  <h5 class="h4 text-white">
                    {{ $t("features.processStep2Title") }}
                  </h5>
                  <p class="mt-4 mb-0 text-white">
                    {{ $t("features.processStem2Info") }}
                  </p>
                </div>
              </div>
            </div>
            <div class="col-lg-3">
              ...
              >
                <div class="card-body">
                  <h5 class="h4 text-white">
                    {{ $t("features.processStep3Title") }}
                  </h5>
                  <p class="mt-4 mb-0 text-white">
                    {{ $t("features.processStem3Info") }}
                  </p>
                </div>
              </div>
            </div>
            <div class="col-lg-3">
              ...
              >
                <div class="card-body">
                  <h5 class="h4 text-white">
                    {{ $t("features.processStep4Title") }}
                  </h5>
                  <p class="mt-4 mb-0 text-white">
                    {{ $t("features.processStem4Info") }}
                  </p>
                </div>
              </div>
            </div>
      ...
      <section class="slice slice-lg bg-gradient-primary">
        ...
        <div class="mb-5 text-center">
          <h3 class="text-white mt-4">
            {{ $t("features.recentProposalTitle") }}
          </h3>
          <div class="fluid-paragraph mt-3">
            <p class="lead lh-180 text-white">
              {{ $t("features.recentProposalSubtitle") }}
            </p>
          </div>
        </div>
        <div class="container">
          <div class="table-responsive-lg">
            <table class="table table-padded align-items-center">
              <tbody>
                <tr
                  v-for="proposal in proposals('active').slice(0, 5)"
                  :key="proposal.id"
                  class="mb-3"
                >
                  <td scope="row">
                    <div class="media align-items-center">
                      ...
                      <div class="media-body">
                        <a
                          ...
                          target="_blank"
                          >{{
                            proposal.subject.length > 30
                              ? proposal.subject.slice(0, 30) + ".."
                              : proposal.subject
                          }}</a
                        >
                      </div>
                  ...
                  <td>
                    <span class="h6"
                      >{{ $filters.numeric(proposal.daily_pay) }} HBD</span
                    >
                  </td>
                  <td>
                    <span class="h6"
                      >{{ $filters.numeric3(proposal.duration ) }}
                      {{ $t("common.days") }}</span
                    >
                  </td>
                  <td>
                    <span class="h6"
                      >{{ $filters.numeric3(proposal.total_votes) }} HP</span
                    >
                  </td>
                </tr>
              </tbody>
        ...
        <div class="text-center mt-5">
          <router-link to="/proposals" class="text-white">
            ...
            >{{ $t("features.viewAllProposalsLabel") }}
          </router-link>
        </div>
      </section>
    </div>
        ...
        <div class="col-lg-3 col-6 mb-5 mb-lg-0">
          <div class="text-center">
            ...
            <span class="d-block mt-4 h3 text-dark"
              >{{ $filters.numeric3(totalBudget) }} HBD</span
            >
        ...
        <div class="col-lg-3 col-6 mb-5 mb-lg-0">
          <div class="text-center">
            ...
            <span class="d-block mt-4 h2 text-danger"
              >{{ $filters.numeric3(dailyBudget) }} HBD</span
            >
