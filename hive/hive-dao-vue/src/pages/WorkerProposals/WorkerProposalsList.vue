          ...
          >
            ...
            <div class="pi-foot pb-0">
              <span class="extra-info text-wrap">
                <ul>
                  <li>
                    <strong>{{ $filters.numeric3(proposal.total_votes) }} HP</strong>
                  </li>
                  <li>
                    <strong>{{ $filters.numeric(proposal.daily_pay) }}</strong>
                    HBD / {{ $t("common.day") }}
                  </li>
                  <li>
                    <strong>{{ $filters.numeric(proposal.total_requested) }}</strong>
                    HBD {{ $t("common.total") }}
                  </li>
                  <li>
                    <strong>{{ $filters.dateFilter(proposal.start_date) }}</strong>
                    -
                    <strong>{{ $filters.dateFilter(proposal.end_date) }}</strong>
                  </li>
                </ul>
              </span>
            </div>
