  ...
  await apiService.post({
    ...
    .then(async (data) => {
      try {
        ...
        returnProposal = await fetchReturnProposal().then((data) => { return data.returnProposal });
...
export async function fetchReturnProposal(): Promise<IProposalResult> {
  let returnProposal: IProposal;
  await apiService.post({
    url: `${config.hiveConfig}`,
    body: {
